...
(function ($) {
    ...
    $.fn.fileinputLocales['ro'] = {
        ...
        msgSizeTooSmall: 'Fișierul "{name}" (<b>{size} KB</b>) depășește limita minimă de încărcare de <b>{minSize} KB</b>.',
        ...
        msgInvalidFileName: 'Caractere nevalabile sau neacceptate în numele fișierului "{name}".',
        ...
        msgUploadAborted: 'Încărcarea fișierului a fost întreruptă',
        ...
        msgAjaxError: 'Ceva a mers rău cu operația {operation}. Va rugăm să încercați mai târziu!',
        msgAjaxProgressError: '{operation} a eșuat',
        ajaxOperations: {
            deleteThumb: 'șterge fișier',
            uploadThumb: 'încarcă fișier',
            uploadBatch: 'încarcă grup fișiere',
            uploadExtra: 'încarcă date formular'
        },
        dropZoneTitle: 'Trage fișierele aici &hellip;',
        dropZoneClickTitle: '<br>(sau click pentru a selecta {files})',
        fileActionSettings: {
            removeTitle: 'Scoateți fișier',
            uploadTitle: 'Încarcă fișier',
            uploadRetryTitle: 'Reîncearcă descărcare',
            downloadTitle: 'Descarcă fișier',
            zoomTitle: 'Vezi detalii',
            dragTitle: 'Mișcă / Rearanjează',
